...
def main():
    ...
    # Create additional splits for the training set
    temp_train_folder = os.path.join(dest_base_path, 'temp_train')
    os.makedirs(temp_train_folder, exist_ok=True)
    ...
    # Create additional splits for the validation set
    ...
    for i in range(len(args.additional_splits)):
        num_to_select = val_count // len(args.additional_splits)
    ...
    # Remove temporary training and validation sets
